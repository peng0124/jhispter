...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "xfadmin@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "xfadmin API";

        private String description = "xfadmin API documentation";
