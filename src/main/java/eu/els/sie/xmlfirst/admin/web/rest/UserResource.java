...
import eu.els.sie.xmlfirst.admin.domain.User;
import eu.els.sie.xmlfirst.admin.repository.AuthorityRepository;
import eu.els.sie.xmlfirst.admin.repository.UserRepository;
import eu.els.sie.xmlfirst.admin.security.AuthoritiesConstants;
import eu.els.sie.xmlfirst.admin.service.MailService;
import eu.els.sie.xmlfirst.admin.service.UserService;
import eu.els.sie.xmlfirst.admin.web.rest.dto.ManagedUserDTO;
import eu.els.sie.xmlfirst.admin.web.rest.dto.UserDTO;
import eu.els.sie.xmlfirst.admin.web.rest.util.HeaderUtil;
import eu.els.sie.xmlfirst.admin.web.rest.util.PaginationUtil;
