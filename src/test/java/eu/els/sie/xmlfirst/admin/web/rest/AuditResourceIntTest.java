...
import eu.els.sie.xmlfirst.admin.config.audit.AuditEventConverter;
import eu.els.sie.xmlfirst.admin.domain.PersistentAuditEvent;
import eu.els.sie.xmlfirst.admin.repository.PersistenceAuditEventRepository;
import eu.els.sie.xmlfirst.admin.service.AuditEventService;
